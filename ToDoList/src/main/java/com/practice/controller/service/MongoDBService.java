...
public class MongoDBService {
    ...
    private final MongoDbInstanceId mongoDbInstanceId;

    private void setCollectionName(String listName) {
        table = db.getCollection(listName);
    }

        MongoDBService(MongoDbInstanceId mongoDbInstanceId) {
            if (mongoDbInstanceId == null) {
                throw new IllegalArgumentException("Mongo DB Id cannot be null");
            }

            this.mongoDbInstanceId = mongoDbInstanceId;

            try {
                Mongo mongoClient = new MongoClient(mongoDbInstanceId.getHostName(), mongoDbInstanceId.getPort());
                db = mongoClient.getDB(mongoDbInstanceId.getDbName());
   ...
   /* public MongoDBServiceEnum getInstance(final String hostName, final int port){
    ...
    public MongoDbInstanceId getMongoDbInstanceId() {
        return mongoDbInstanceId;
    }
}
