...
public class ServerTest {
	...
	static class TestDao implements Dao<String> {
        ...
        @Override
        public List<com.practice.controller.dao.ResponseObject> get(String listId) {
            return null;
        }

        @Override
        public List<com.practice.controller.dao.ResponseObject> get(String listId, int index) {
            return null;
        }

        @Override
		public String getById( String id ) {
			if ( id.equals( "id1" ) ) return "stuff2";
			return null;
		}
	}
	...
	public void startServer() throws IOException {
		...
		ResourceConfig rc = new PackagesResourceConfig( "com.practice.controller.server" );
